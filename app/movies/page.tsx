...
export default function MoviesPage() {
  ...
  useEffect(() => {
    const fetchAll = async () => {
      // Combine multiple movie endpoints to create a large movie collection
      const [action, comedy, romance] = await Promise.all([
      ...
      const allMovies = [...action, ...comedy, ...romance];
    ...
    <div className="relative min-h-screen bg-white">
      ...
      <main className="relative pb-24 pt-28 px-6 md:px-12 max-w-7xl mx-auto min-h-[70vh]">
        {searchResults ? (
          ...
          <>
            <h1 className="text-3xl font-bold mb-8 text-neutral-900 tracking-tight">Full Length Movies</h1>
