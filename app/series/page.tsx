...
export default function SeriesPage() {
  ...
  useEffect(() => {
    const fetchAll = async () => {
      const results = await getMovies(requests.fetchNetflixOriginals);
      setSeries(results);
      setLoading(false);
    };
    ...
    <div className="relative min-h-screen bg-white">
      ...
      <main className="relative pb-24 pt-28 px-6 md:px-12 max-w-7xl mx-auto min-h-[70vh]">
        {searchResults ? (
          ...
          <>
            <h1 className="text-3xl font-bold mb-8 text-neutral-900 tracking-tight">TV Series Collection</h1>
